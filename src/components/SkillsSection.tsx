            ...
            <CardContent className="pt-4">
              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill) => (
                  <div 
                    key={skill} 
                    className="bg-portfolio-lightest/5 text-portfolio-light-slate px-3 py-1.5 rounded-md text-sm border border-portfolio-lightest/10 hover:border-portfolio-teal/30 transition-all duration-200"
                  >
                    {skill}
                  </div>
                ))}
